                    ...
                    <div className='flex'>
                        ...
                        <div className="flex flex-col gap-2">
                            {formErrors.userName && <p className="text-center text-red-500">{formErrors.userName.message}</p>}
                                ...
                                <input id="username" className="border border-black rounded w-[400px] focus:ring focus:ring-green-500" type="text" onChange={handleUserName} value={userName}/>
                            </div>
                            <div className="flex flex-col gap-2">
                            {formErrors.firstName && <p className="text-center text-red-500">{formErrors.firstName.message}</p>}
                                <label htmlFor="firstName">First Name: </label>
                                <input id="firstName" className="border border-black rounded w-[400px] focus:ring focus:ring-green-500" type="text" onChange={handleFirstName} value={firstName}/>
                            </div>
                            <div className="flex flex-col gap-2">
                            {formErrors.lastName && <p className="text-center text-red-500">{formErrors.lastName.message}</p>}
                                <label htmlFor="lastName">Last Name: </label>
                                <input id="lastName" className="border border-black rounded focus:ring focus:ring-green-500" type="text" onChange={handleLastName} value={lastName}/>
                            </div>
                            <div className="flex flex-col gap-2">
                            {formErrors.email && <p className="text-center text-red-500">{formErrors.email.message}</p>}
                                <label htmlFor="email">Email: </label>
                                <input id="email" className="border border-black rounded focus:ring focus:ring-green-500" type="text" onChange={handleEmail} value={email}/>
                            </div>
                        </section>
                    </div>
